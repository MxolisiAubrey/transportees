...
<div class="row">
  <div class="col-sm-2">
    ...
    <div class="col-sm-10">
    <h4 class="display-4 lead text-center">Transportee Management System</h4>
    </div>
  </div>
  <form action="<?php echo base_url('./Signup');?>" method="post">
<div class="signup-form">
<h2>Register</h2>
<p class="hint-text">Create an account to start managing your transportees.</p>
...
<div class="row">
    <div class="col">
      <?php echo form_input(['name'=>'firstname','class'=>'form-control','value'=>set_value('firstname'),'placeholder'=>'First Name']);?>
      <?php echo form_error('firstname',"<div style='color:red'>","</div>");?>
 
   </div> 
      <div class="col">
         <?php echo form_input(['name'=>'lastname','class'=>'form-control','value'=>set_value('lastname'),'placeholder'=>'Last Name']);?>
...
<div class="form-group">
   <?php echo form_input(['name'=>'emailid','class'=>'form-control','value'=>set_value('emailid'),'placeholder'=>'Email']);?>
...
<div class="form-group">
     ...
     <?php echo form_close();?>
	 <div class="text-center">Already have an account? <a href="<?php echo base_url('Signin');?>">Sign in</a></div>
</div>
</body>
</html>